...
/*============== PAYMENT ==============*/
global.pdana = '"_"' //Nomor Danamu
global.ppulsa = '085640159364' //Nomor SimCard Yang Kamu Pake
global.psaweria = '"_"' //Link Saweriamu Kalo Nggada Ketik - aja

/*============== NOMOR ==============*/
global.nomorbot = '087735630934' //Nomor Bot
global.nomorown = '6285640159364' //Nomor Owner
global.namebot = 'Elaina BOT' //Nama Bot
global.nameown = 'Dit' // Nama Owner


/*============== STAFF ==============*/
global.owner = [
  ['6285640159364', '❦ Dit - 𝚈𝚊𝚗? 🎐', true] //Ganti jd nomormu sama Namamu
